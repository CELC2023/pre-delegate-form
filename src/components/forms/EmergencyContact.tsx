    ...
    return (
        <>
            ...
            <FormContent>
                ...
                <TextInput name="emergencyContactPhone" label={t('field-phone-number')} control={control} setErrors={setError} clearErrors={clearErrors} validation={validatePhone} required={true} type={'tel'} />
