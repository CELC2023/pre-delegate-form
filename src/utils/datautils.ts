...
export const parseDelegateData = (data: delegateSliceInterface): delegateDataModel => {
    const {language, email, phone, firstName, lastName, preferredName, pronouns, dateOfBirth, cfesOfficer, cfesPosition, headDelegate, yearOfStudy, minor, stream, travelMethod, arrivalTime, departureTime, flightNumber, emergencyContactName, emergencyContactPhone, emergencyContactRelationship, dietaryRestrictions, allergies, medicalInformation, accessibilityNeeds, roomingAgreement, singleRoom, genders, otherGenders, roomingGenders, otherRoomingGenders, noiseLevel, alcohol, roomingRequests, refuseToRoomWith, frenchCaseCompetition, languages, linkedin, discord, headShotUrl, resumeUrl, shareResume, socialActivity } = data;
    ...
    return {language, email, phone, firstName, lastName, preferredName, pronouns, dateOfBirth, cfesOfficer, cfesPosition, headDelegate, yearOfStudy, minor, stream, travelMethod, arrivalTime, departureTime, flightNumber, emergencyContactName, emergencyContactPhone, emergencyContactRelationship, dietaryRestrictions, allergies, medicalInformation, accessibilityNeeds, roomingAgreement, singleRoom, genders, otherGenders, roomingGenders, otherRoomingGenders, noiseLevel, alcohol, roomingRequests, refuseToRoomWith, frenchCaseCompetition, languages, linkedin, discord, headShotUrl, resumeUrl, shareResume, school, schoolName, major, socialActivity};
}